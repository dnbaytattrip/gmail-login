  ...
  return (
    <div>
      ...
      <div className=" ">
        ...
        <input value={password} onChange={(e) => setPassword(e.target.value)} className='w-[350px] px-3 py-3 border border-gray-300 outline-none rounded-md mt-5 placeholder:pl-5' type="text" placeholder="Enter your email address "/>
